...
struct RecordingShareMenuView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        RecordingShareMenuView(rec: Recording(fileURL: fileUrl, createdAt: Date(), fileName: "Nom du fichier", dowloadURL: nil), audioRecorder: AudioRecorder()).environmentObject(AppManager())
    }
}
